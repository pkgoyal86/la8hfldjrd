angular.module('starter.controllers').controller('uploadImageCtrl', function($rootScope,$scope,$http,$ionicLoading,$state,$ionicPopup,$stateParams,$cordovaCamera, $cordovaFile, $cordovaFileTransfer, $cordovaDevice,$cordovaActionSheet) {
